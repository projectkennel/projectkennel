...
//! `kennel-bin-ssh-reorigin`: the SSH re-origination forced command (`docs/design/07-10-ssh.md` §7.10.4).
//!
//! # Role
//!
...
//!
//! ```text
//! restrict,pty,command="kennel-bin-ssh-reorigin --dest github.com --key SHA256:<K>" <synthetic-pub>
//! ```
//!
