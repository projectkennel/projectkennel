...
mod tests {
    ...
    /// A fully-populated view touching every `ShimView` field the codec handles.
    fn rich_view() -> ShimView {
        ShimView {
            ...
            binds: vec![
                ...
                BindMount {
                    source: PathBuf::from("/home/op/stores/acme/cred.json"),
                    target: PathBuf::from("/home/kennel/.app/cred.json"),
                    writable: false,
                    exclusive: false,
                    redirected: true,
                },
