...
Changes to this tree follow the review discipline in [CODING-STANDARDS.md](../CODING-STANDARDS.md) §13. The three-phase commit cadence (§7.1) does not apply directly — architecture documents are not test-driven — but:
...
- The threat catalogue (see [THREATS.md](../THREATS.md)).
- The design rationale (see [docs/](../docs/)).
- Policy template examples (see [TEMPLATE-ai-coding-strict.md](../TEMPLATE-ai-coding-strict.md) for the canonical worked example).
- Contributor-facing guidance (see [CONTRIBUTING.md](../CONTRIBUTING.md)).
- Project-wide engineering rules (see [CODING-STANDARDS.md](../CODING-STANDARDS.md)).
