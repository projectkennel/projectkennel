...
│   │   ├── kennel-syscall/          syscalls/namespaces/seccomp/FFI (unsafe); re-exports kennel-os + kennel-landlock
│   │   ├── kennel-os/               safe OS helpers (path, uid/gid, netlink, handshake); re-exported by kennel-syscall
│   │   ├── kennel-landlock/         hand-rolled Landlock ABI (unsafe; 4th unsafe crate); re-exported by kennel-syscall
