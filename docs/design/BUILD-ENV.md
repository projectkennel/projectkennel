...
The kernel versions CI loads the BPF programs against (`docs/architecture/06-build-and-test.md`, `02-5-bpf-abi.md`). Verifier rejection on any entry blocks merge.
