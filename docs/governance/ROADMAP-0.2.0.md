...
Status: **building — 14 of 15 original workstreams landed** (2026-06-19); **W15** (as-built prose pass) open; **W16** (facade-client poll-elimination → inbound mirror push) **built + merged** (2026-06-20); **Thrust 5 / W17–W19** (OCI substrate execution) **built + proven** (2026-06-20), incl. **W17c** the confined `skopeo`+`umoci` fetch under the vendor `oci-fetch@v1`; a first-party in-kennel unpacker (replacing the umoci host dep) is a 0.3 follow-up · Drafted: 2026-06-18 · Targets: 0.2.0
