...
This file lists contributors who have earned trusted status per [CODING-STANDARDS.md](CODING-STANDARDS.md) §13.4. It is referenced by the close-on-arrival rules for issues (§13.5) and PRs (§13.4).
...
## Current trusted contributors

| Name | Contact | Since |
|---|---|---|
| *(none yet — the project is pre-implementation)* | | |
